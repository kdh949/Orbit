...
import {
  buildRehearsalCompletionSummary,
  buildRehearsalPreflightBanner,
  createRehearsalPracticeSummary,
  readRehearsalPracticeSummary,
  type RehearsalPracticeSummary,
  writeRehearsalPracticeSummary,
} from "./completion/rehearsalCompletionModel";
import { RehearsalTeleprompter } from "./completion/RehearsalTeleprompter";
...
export function RehearsalWorkspaceController(props: RehearsalWorkspaceProps) {
