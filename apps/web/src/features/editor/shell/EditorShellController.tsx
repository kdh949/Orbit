...
import {
  ...
  getSaveErrorStatusLabel,
  getSaveRecoveryHint,
  isSaveInFlight,
  pptxImportMenuMeta
} from "./editorStatusModel";
...
export type EditorShellProps = { projectId?: string };

export default function EditorShellController(props: EditorShellProps) {
