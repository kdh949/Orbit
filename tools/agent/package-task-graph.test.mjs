...
test("실제 linter가 없는 workspace는 typecheck를 lint로 중복 실행하지 않는다", () => {
  ...
  assert.equal(root.scripts.lint, undefined);
