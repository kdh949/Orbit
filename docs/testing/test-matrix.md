...
| Task 8 fidelity harness | fixture 검증 통과, threshold acceptance 미완료 | inherited placeholder frame, known drift, private calibration fail-closed test, PowerPoint 7개/139장 identity diff와 두 LibreOffice candidate의 SSIM 1.0·changed pixel/structural/package drift 0·461 checksum; Office-font diagnostic은 exact 320/substituted 31; Google Fonts 공개 후보 3개 바이너리/OFL/name table audit은 요청된 4개 문자열이 현 exact-family 규칙을 충족하지 않음을 확인 | 남은 exact font·license 또는 승인된 alias 계약과 threshold 사람 승인 |
| Checkpoint B2 | actual text/image slot 기계 검증 통과, 승인 보류 | text 253/253와 7개 PowerPoint sync/export, 사용자 image 5개 승인, 4개 disabled version 2 proposal, `/private/tmp/orbit-ooxml-image-slot-roundtrip-capacity-v2-20260723-a` 및 `/private/tmp/orbit-ooxml-powerpoint-image-slot-roundtrip-capacity-v2-20260723-b`의 5/5 warning/unsupported/package/reimport 0과 LibreOffice/PowerPoint reopen | operating 42px·simple-light 72px locked diff 사람 판정, exact font, production publication과 전체 사람 검수 |
...
| Task 12 7-template 확장 | 7개 actual 8장 generation과 text-slot edit 검증 통과 | package warning·overflow·overlap·crop 0, LibreOffice 56장과 `/private/tmp/orbit-ooxml-powerpoint-full-deck-montage-metadata-fixed-20260723-b`의 PowerPoint 7×8장 checksum/montage/report; `Slides=8`, stale/private metadata 0 | production publication, exact font QA와 사람 검수 |
