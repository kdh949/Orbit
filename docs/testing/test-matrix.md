...
| Task 8 fidelity harness | 자동 통과 | inherited placeholder frame, slot frame/relationship known drift, package font exact resolve, private calibration fail-closed test와 7개/56장 artifact runner | 7개 full identity-control diff, exact font environment와 threshold 사람 승인 |
...
| Task 12 7-template 확장 | 7개 actual 8장 generation과 text-slot edit 검증 통과 | package warning·overflow·overlap·crop 0, LibreOffice 56장, PowerPoint 7×8장, template별 checksum/report와 locked montage | production publication, exact font QA와 사람 검수 |
| Checkpoint C | 자동 검증 7/7 통과, strict 상태 `failed` | 7개 actual full-deck sequence/package/PowerPoint/LibreOffice, actual slot sync/reopen과 `/private/tmp/orbit-ooxml-fidelity-artifacts-20260723-f`; 351개 resolved font checksum을 기록했지만 strict evidence는 `FONT_AVAILABILITY_VALIDATION_PENDING` 유지 | requested exact font 설치/checksum, production storage와 사람 fidelity 승인 |
...
| Checkpoint D2 | 부분 통과, 승인 보류 | build 10/10, lint/test 17/17, Python 1,034, PostgreSQL PPTX round-trip 7/7, `/createdeck` Chrome 2/2, flag off/allowlist rollback, actual 7개 edit/export PowerPoint/LibreOffice와 7개/56장 fidelity artifact | real API→queue→publication E2E, production storage, requested exact font와 사람 승인 |
